...
export function alert(type, message) {
    ...
    //Close alert
    setTimeout(() => { removeAlertStyle(div) }, showDuration);
}

export function alertException(exceptCode) {
...
function addAlertStyle(div) {
    ...
    setTimeout(() => { div.style.left = left + 'px'}, 100);
}
