export const ua = {
  ...
  Send: 'Надіслати',
  'Lang code not set.': 'Мова відправки емейлу не визначена.',
  'Account successful activated. You can log in!': 'Аккаунт успішно активовано. Ви можете авторизуватись!',
  'User with this email not found': 'Користувача з таким емейлом не існує',
  'This email has already been taken': 'Цей емейл зайнятий другим користувачем',
  // '': '',
  // '': '',
  // '': '',
  // '': '',
